...
model = SentenceTransformer(
    "track-b/track-b-simcse/checkpoints/facebookai-roberta-large"
)
...
np.save(f"track-b/experiments/facebookai-roberta-large/output/facebookai-roberta-large.npy", embeddings)