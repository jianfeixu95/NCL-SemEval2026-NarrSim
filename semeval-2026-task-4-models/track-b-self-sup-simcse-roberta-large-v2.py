...
model = SentenceTransformer(
    "track-b/track-b-simcse/checkpoints/self-simcse-roberta-large-v2"
)
...
np.save(f"track-b/experiments/self-sup-simcse-roberta-large-v2/output/self-sup-simcse-roberta-large-v2.npy", embeddings)
