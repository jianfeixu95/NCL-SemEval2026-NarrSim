...
model = SentenceTransformer(
    "track-b/track-b-simcse/checkpoints/self-simcse-roberta-large-v1"
)
...
np.save(f"track-b/experiments/self-sup-simcse-roberta-large-v1/output/self-sup-simcse-roberta-large-v1.npy", embeddings)
