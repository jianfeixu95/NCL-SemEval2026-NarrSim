...
model = SentenceTransformer(
    "track-b/track-b-simcse/checkpoints/ncl-sup-simcse-roberta-large-v1"
)
...
np.save(f"track-b/experiments/ncl-sup-simcse-roberta-large-v1/output/ncl-sup-simcse-roberta-large-v1.npy", embeddings)
