...
model = SentenceTransformer(
    "../track-b-simcse/checkpoints/docnil-pretrained-roberta-model/hf"
)
...
np.save(f"docnil-pretrained-roberta-model/output/track-b-docnil-pretrained-roberta-model.npy", embeddings)
