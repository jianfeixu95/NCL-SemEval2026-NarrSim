...
model = SentenceTransformer(
    "../track-b-simcse/runs/finetune-princeton-nlp-sup-simcse-roberta-large_20260129_172426"
)
...
np.save(f"../experiments/ track-b-finetune-train-aug-princeton-nlp-sup-simcse-roberta-large/output/track-b.npy", embeddings)
