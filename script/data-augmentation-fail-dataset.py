...
if __name__ == "__main__":
    ...
    jsonl_path = "../semeval-2026-task-4-datasets/semeval-2026-task-4-train-v1/train_track_a_augmented.jsonl"
    ...
    filter_csv_by_missing_anchor(
        ...
        output_csv_path="../semeval-2026-task-4-datasets/semeval-2026-task-4-train-v1/train_track_a_augmented_buchong.csv"
    )
