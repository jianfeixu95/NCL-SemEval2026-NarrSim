...
PROMPT_TEMPLATE = r"""
You are a professional narrative data constructor. Based on three minimal narrative prototype sentences (anchor_text / text_a / text_b), you will generate three long-form narratives for a narrative triplet semantic similarity task.
...
# ====== 配置 ======
INPUT_PATH = Path("../semeval-2026-task-4-datasets/story-analogy/story_analogy_flat_train.csv")
OUTPUT_PATH = Path("../semeval-2026-task-4-datasets/story-analogy/story_analogy_flat_train_augmented.jsonl")
